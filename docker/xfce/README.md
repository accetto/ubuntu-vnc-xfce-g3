...
```shell
docker run -d -p 25901:5901 -p 26901:6901 accetto/ubuntu-vnc-xfce-g3
```
...
```shell
docker run -it -P --rm --user 2019 accetto/ubuntu-vnc-xfce-g3
```
...
```shell
docker run -dP accetto/ubuntu-vnc-xfce-g3
```
